...
protected:
    ...
    /* SYSREL extension */
    std::vector<Instruction*> negativeIndexGeps;
    std::vector<Instruction*> variableIndexGeps;
...
public:
    ...
    //virtual void filterForCustomStats(SVFModule svfModule);

    //virtual void customStats(); 
